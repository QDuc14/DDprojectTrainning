...
package com.clt.apps.opus.esm.clv.pratrain1.errmsgmgmt.vo;
 ...
 * Value Object that is created by the relevant Event and acts as a data pass on the server execution request
 *
 * @author 
 * @since J2EE 1.6
...
public class ErrMsgVO extends AbstractValueObject {
	...
	/*	Hashtable that stores the values of a table column */
	...
	/**
	 * Returns the value to be stored in a table column as Hashtable<"column_name", "value">
	 * @return HashMap
	 */
	...
	/**
	 * Save the member variable name corresponding to the column name and return it as Hashtable<"column_name", "variable">   
	 * @return
	 */
...
/**
	 * Request Extract the data of the  and set it in the member variable of the VO.
	 * @param request
	 */
	...
	/**
	 * Request Returns by converting the data in a VO array.
	 * @param request
	 * @return ErrMsgVO[]
	 */
	...
	/**
	 * Request Many of the things that have been passed over put the DATA in the VO Class. 
	 * @param request
	 * @param prefix
	 * @return ErrMsgVO[]
	 */
	...
	/**
	 * Convert the contents of a VO Class to a String
	 */
	...
	/**
	* Remove special characters from formatted strings ("-","/",",",":")
	*/
