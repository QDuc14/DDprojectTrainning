...
<form name="form">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><button type="button"><span id="title">PRACTIC 3</span></button></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
		...
		--><button type="button" class="btn_normal" name="btn_Down" id="btn_Down">Down Excel2</button>
		</div>
		<!-- opus_design_btn(E) -->
		<!-- page_location(S) -->
		<div class="location">
				...
				<tbody>
					...
					<tr class="h23">
						...
						<td><input type="text" style="width: 80px" class="input1" dataformat="ym" maxlength="7" name="fm_acct_yrmon" value="" id="fm_acct_yrmon"  /><!--  
							...
							--><input type="text" style="width: 80px" class="input1" maxlength="7" dataformat="ym" name="to_acct_yrmon" value="" id="to_acct_yrmon"  /><!-- 
						...
						<th>Partner</th>
						<td>
							<script type="text/javascript">ComComboObject('s_jo_crr_cd', 1, 100, 1, 0);</script>
						</td>
						<th>Lane</th>
						<td>
							<script type="text/javascript">ComComboObject('s_rlane_cd', 1, 100, 1, 0);</script>
						</td>
						<th>Trade</th>
						<td>
