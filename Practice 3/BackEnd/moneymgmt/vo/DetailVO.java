...
public class DetailVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("acct_yrmon_fm", getAcctYrmonFm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("acct_yrmon_fm", "acctYrmonFm");
	 ...
	 * @param acctYrmonFm
	 */
	public void setAcctYrmonFm(String acctYrmonFm) {
		this.acctYrmonFm = acctYrmonFm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAcctYrmonFm(JSPUtil.getParameter(request, prefix + "acct_yrmon_fm", ""));
	...
	public DetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] acctYrmonFm = (JSPUtil.getParameter(request, prefix	+ "acct_yrmon_fm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (acctYrmonFm[i] != null)
					model.setAcctYrmonFm(acctYrmonFm[i]);
