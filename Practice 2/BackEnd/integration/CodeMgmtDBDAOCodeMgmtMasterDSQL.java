...
*@FileName : CodeMgmtDBDAOCodeMgmtMasterDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtMasterDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtMasterDSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtMasterDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
