...
*@FileName : CodeMgmtDBDAOCodeMgmtMasterCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtMasterCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtMasterCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtMasterCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
