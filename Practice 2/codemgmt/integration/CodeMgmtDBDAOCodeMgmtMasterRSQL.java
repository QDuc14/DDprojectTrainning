...
*@FileName : CodeMgmtDBDAOCodeMgmtMasterRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtMasterRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtMasterRSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtMasterRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
