...
*@FileName : CodeMgmtDBDAOCodeMgmtMasterUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOCodeMgmtMasterUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOCodeMgmtMasterUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOCodeMgmtMasterUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
